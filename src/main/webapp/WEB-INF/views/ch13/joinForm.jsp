...
<div class="card">
	...
	<div class="card-body">
		<form id="joinForm" method="post" action="join" enctype="multipart/form-data" >
			...
			<div class="input-group mt-2">
				...
				<input id="mname" name="mname" type="text" class="form-control" value="${chMember.mname}" />
			</div>
		
			<div class="input-group mt-2">
				<div class="input-group-prepend"><span class="input-group-text">패스워드</span></div>
			...
			<div class="input-group mt-2">
				...
				<input id="memail" type="email" name="memail" class="form-control" ${chMember.email } />
			</div>
			...
			<div class="mt-3">
				<input type="submit" class="btn btn-info btn-sm" value="가입" />
				<input type="reset" class="btn btn-info btn-sm" value="재작성" />
			</div>
		</form>
	</div>
</div>
